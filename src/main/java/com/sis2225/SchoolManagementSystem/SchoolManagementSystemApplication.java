	...
	public class SchoolManagementSystemApplication {
		...
		public static void main(String[] args) {
			...
			SysUser student1 = new Student("Alibek", "Nurdaulet",18,11);
			student1.setUsername("baka");
			student1.setPassword("asdf");
			SysUser student2 = new Student("Baka", "Durachkov",17,11);
			SysUser student3 = new Student("Сырна", "Сырный",16,11);
